...
void main() {
  testWidgets('default height >= 64dp', (tester) async {
    ...
    expect(tester.getSize(find.byType(BigButton)).height, greaterThanOrEqualTo(64));
  });
  ...
  testWidgets('critical height >= 72dp', (tester) async {
    ...
    expect(tester.getSize(find.byType(BigButton)).height, greaterThanOrEqualTo(72));
  });
  ...
  test('empty label is rejected', () {
    expect(() => BigButton(label: '  ', onPressed: () {}), throwsAssertionError);
  });
}
